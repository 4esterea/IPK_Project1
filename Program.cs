...
namespace IPKScanner
{
    ...
    {
        public static void Scan(CommandLineArguments args)
        {
            Console.WriteLine("\nScanning parameters:");
            Console.WriteLine($"Interface: \t{args.Interface}");
            Console.WriteLine($"TCP Ports: \t{string.Join(", ", args.TcpPorts)}");
            Console.WriteLine($"UDP Ports: \t{string.Join(", ", args.UdpPorts)}");
            Console.WriteLine($"Timeout: \t{args.Timeout} ms");
            Console.WriteLine($"Target: \t{args.Host}");
        }
    }
}